...
(:init
  ...
  ;(samochodzik3 tir3 pa5 pb5 pc5 vertical)
        ...
        (samochodzik2 red pc1 pc2 horizontal)
        (samochodzik2 car1 pb3 pc3 vertical)
        (samochodzik3 tir1 pd1 pd2 pd3 horizontal)
        (samochodzik2 car2 pe1 pf1 vertical)
        (samochodzik2 car3 pe2 pf2 vertical)
        (samochodzik2 car4 pe3 pf3 vertical)
        (samochodzik3 tir2 pb5 pc5 pd5 vertical)
        (samochodzik2 car5 pe5 pe6 horizontal)
        (samochodzik2 car6 pf5 pf6 horizontal)
        (samochodzik2 car7 pc6 pd6 vertical)
